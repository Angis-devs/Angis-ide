...
_IT_UI = {
    ...
    "angis_files": "File Angis",
    "all_files": "Tutti i file",
    "text_files": "File di testo",
    "set_language": "Imposta Lingua",
    "choose_language": "Scegli la lingua dell'IDE:",
    "apply": "Applica",
    "cancel": "Annulla",
    "loading": "Caricamento...",
    "game_over": "Game Over",
    "canvas_ready": "Canvas pronto",
    "use_wasd": "Usa WASD o le frecce per muoverti",
    "score": "Punteggio",
    "click_or_space": "Clicca o premi Spazio per volare",
    "click_restart": "Clicca o premi Spazio per ricominciare",
}
...
_PT_UI = {
    ...
    "window_title": "IDE Angis",
    "untitled": "sem título",
    "angis_files": "Arquivos Angis",
    "all_files": "Todos os arquivos",
    "text_files": "Arquivos de texto",
    "set_language": "Definir Idioma",
    "choose_language": "Escolha o idioma do IDE:",
    "apply": "Aplicar",
    "cancel": "Cancelar",
    "loading": "Carregando...",
    "game_over": "Fim de Jogo",
    "canvas_ready": "Tela pronta",
    "use_wasd": "Use WASD ou setas para mover",
    "score": "Pontuação",
    "click_or_space": "Clique ou pressione Espaço para voar",
    "click_restart": "Clique ou pressione Espaço para reiniciar",
}
...
ITALIAN = LangPack(
    code="it",
    name="Italiano",
    print_words={"dire", "mostra", "stampa", "scrivi", "visualizza"},
    set_words={"imposta", "fai", "lascia", "salva", "crea"},
    math_words={"aggiungi", "più", "somma", "calcola", "sottrai", "meno", "moltiplica", "per", "dividi"},
    app_words={"app", "finestra", "testo", "etichetta", "bottone", "scena", "mondo"},
    game_words={"gioco", "flappy"},
    file_words={"allega", "file", "localizza", "trova"},
    to_prep={"a"},
    equal_prep={"uguale", "="},
    for_prep={"per"},
    in_prep={"in", "dentro"},
    ...
    on_word="acceso",
    off_word="spento",
    switch_word="seleziona",
    match_word="confronta",
    case_word="caso",
    when_word="quando",
    default_word="predefinito",
    otherwise_word="altrimenti",
    define_word="definisci",
    function_word="funzione",
    return_word="ritorna",
    call_word="chiama",
    blueprint_word="progetto",
    create_word="crea",
    named_word="chiamato",
    method_word="metodo",
    phrase_word="frase",
    command_word="comando",
    means_word="significa",
    teaching_words={"quando dico", "insegna"},
    repeat_word="ripeti",
    times_word="volte",
    while_word="mentre",
    for_each_words={"per ogni"},
    collect_word="raccogli",
    get_word="ottieni",
    lambda_word="lambda",
    arrow_word="freccia",
    fn_word="fn",
    ...
    import_word="importa",
    python_word="python",
    include_word="includi",
    library_word="libreria",
    pack_word="pacchetto",
    use_word="usa",
    show_word="mostra",
    say_word="dire",
    display_word="visualizza",
    tell_word="racconta",
    ask_word="chiedi",
    input_word="input",
    prompt_word="richiesta",
    read_word="leggi",
    raise_word="lancia",
    error_word="errore",
    assert_word="asserisci",
    debug_word="debug",
    all_word="tutto",
    language_word="lingua",
    true_word="vero",
    false_word="falso",
)
ITALIAN._ui = dict(_IT_UI)


PORTUGUESE = LangPack(
    code="pt",
    name="Português",
    print_words={"diga", "mostre", "imprima", "escreva", "exiba"},
    set_words={"defina", "faça", "deixe", "guarde", "crie"},
    math_words={"adicione", "mais", "soma", "calcule", "subtraia", "menos", "multiplique", "vezes", "divida"},
    app_words={"app", "janela", "texto", "rótulo", "botão", "cena", "mundo"},
    game_words={"jogo", "flappy"},
    file_words={"anexe", "arquivo", "localize", "encontre"},
    to_prep={"para"},
    equal_prep={"igual", "="},
    for_prep={"para"},
    in_prep={"em", "dentro"},
    ...
    or_word="ou",
    not_word="não",
    true_words={"verdadeiro", "sim"},
    false_words={"falso", "não"},
    on_word="ligado",
    off_word="desligado",
    switch_word="selecione",
    match_word="corresponder",
    case_word="caso",
    when_word="quando",
    default_word="padrão",
    otherwise_word="caso contrário",
    define_word="defina",
    function_word="função",
    return_word="retorne",
    call_word="chame",
    blueprint_word="projeto",
    create_word="crie",
    named_word="chamado",
    method_word="método",
    phrase_word="frase",
    command_word="comando",
    means_word="significa",
    teaching_words={"quando eu disser", "ensine"},
    repeat_word="repita",
    times_word="vezes",
    while_word="enquanto",
    for_each_words={"para cada"},
    collect_word="coletar",
    get_word="obter",
    lambda_word="lambda",
    arrow_word="seta",
    fn_word="fn",
    ...
    finally_word="finalmente",
    with_word="com",
    async_word="assíncrono",
    spawn_word="lançar",
    background_word="fundo",
    await_word="aguarde",
    decorator_char="@",
    yes_words={"sim"},
    no_words={"não"},
...
def set_language(lang: str | LangPack) -> None:
    ...
    if isinstance(lang, LangPack):
        ...
        for pack in [ENGLISH, SPANISH, FRENCH, GERMAN, ITALIAN, PORTUGUESE]:
...
def get_supported_languages() -> list[dict[str, str]]:
    return [
        ...
        for p in [ENGLISH, SPANISH, FRENCH, GERMAN, ITALIAN, PORTUGUESE]
    ]
